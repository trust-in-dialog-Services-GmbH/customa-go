...
type Setting struct {
	Global GlobalValueOfTheSetting `json:"Global"`
	...
	Marketplaces map[string]MarketplaceSpecificValuesOfTheSettingValue `json:"Marketplaces"`
...
func (o *Setting) GetGlobal() GlobalValueOfTheSetting {
	if o == nil {
		var ret GlobalValueOfTheSetting
		return ret
	}
...
func (o *Setting) GetMarketplaces() map[string]MarketplaceSpecificValuesOfTheSettingValue {
	if o == nil {
		var ret map[string]MarketplaceSpecificValuesOfTheSettingValue
		return ret
	}
...
func (o *Setting) GetMarketplacesOk() (map[string]MarketplaceSpecificValuesOfTheSettingValue, bool) {
	if o == nil {
		return map[string]MarketplaceSpecificValuesOfTheSettingValue{}, false
	}
