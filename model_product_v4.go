...
type ProductV4 struct {
	...
	// Category of the product. Deprecated. Use 'Categories' instead.
	// Deprecated
	...
	// Parts of the product, if this product is a product set.
	SetParts []ProductSetPartV4 `json:"SetParts,omitempty"`
...
func (o *ProductV4) SetCategoryNil() {
	o.Category.Set(nil)
}
...
// GetSetParts returns the SetParts field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ProductV4) GetSetParts() []ProductSetPartV4 {
	if o == nil {
		var ret []ProductSetPartV4
		return ret
	}
	return o.SetParts
}

// GetSetPartsOk returns a tuple with the SetParts field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ProductV4) GetSetPartsOk() ([]ProductSetPartV4, bool) {
	if o == nil || IsNil(o.SetParts) {
		return nil, false
	}
	return o.SetParts, true
}
...
// SetSetParts gets a reference to the given []ProductSetPartV4 and assigns it to the SetParts field.
...
func (o ProductV4) ToMap() (map[string]interface{}, error) {
	...
	if o.SetParts != nil {
		toSerialize["SetParts"] = o.SetParts
	}
...
func (o *ProductV4) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ProductV4(varProductV4)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "SetParts")
