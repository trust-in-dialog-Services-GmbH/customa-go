...
// APIClient manages communication with the Customa API v3.14.0
...
type APIClient struct {
	...
	CampaigngroupAPI *CampaigngroupAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.CampaigngroupAPI = (*CampaigngroupAPIService)(&c.common)
